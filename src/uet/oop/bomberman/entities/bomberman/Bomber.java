...
public class Bomber extends MovableEntity {
    ...
    public static final int BOMBER_WAIT_NEXT_STEP = 3;
    public static final int BOMBER_WAIT_NEXT_STEP_FAST = 2;

    public Bomber(int rx, int ry, Image img, int deadAnimation, boolean isAlive,
                  String direction) {
    ...
    private void setHighSpeedState() {
        setSpeed(BOMBER_HIGH_SPEED);
        setWaitNextStep(BOMBER_WAIT_NEXT_STEP_FAST);
    }
