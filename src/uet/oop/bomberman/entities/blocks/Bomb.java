...
public class Bomb extends Entity {
    ...
    private static Bomb left;
    private static Bomb right;
    private static Bomb up;
    private static Bomb down;
    ...
    public void explosion() {
        if (countTransform % 10 == 0) {
            if (animationTransform == 1) {
                ...
                if (Bomb.left != null) {
                    Bomb.left.img = Sprite.explosion_horizontal_left_last1.getFxImage();
                }
                if (Bomb.right != null) {
                    Bomb.right.img = Sprite.explosion_horizontal_right_last1.getFxImage();
                }
                if (Bomb.up != null) {
                    Bomb.up.img = Sprite.explosion_vertical_top_last1.getFxImage();
                }
                if (Bomb.down != null) {
                    Bomb.down.img = Sprite.explosion_vertical_down_last1.getFxImage();
                }
            } else if (animationTransform == 3) {
                this.img = Sprite.bomb_exploded2.getFxImage();
                animationTransform = 4;
                if (Bomb.left != null) {
                    Bomb.left.img = Sprite.explosion_horizontal_left_last2.getFxImage();
                }
                if (Bomb.right != null) {
                    Bomb.right.img = Sprite.explosion_horizontal_right_last2.getFxImage();
                }
                if (Bomb.up != null) {
                    Bomb.up.img = Sprite.explosion_vertical_top_last2.getFxImage();
                }
                if (Bomb.down != null) {
                    Bomb.down.img = Sprite.explosion_vertical_down_last2.getFxImage();
                }
            } else {
