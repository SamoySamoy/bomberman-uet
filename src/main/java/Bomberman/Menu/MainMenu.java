...
public class MainMenu extends FXGLMenu {
    public MainMenu() {
        ...
        background.setImage(new Image("assets/textures/Main_background.jpg"));

        DropShadow dropShadow = new DropShadow();
        dropShadow.setColor(Color.rgb(232, 10, 10));
        ...
        var title = getUIFactoryService().newText(getSettings().getTitle(), Color.rgb(248, 209, 54), 130);
        title.setEffect(dropShadow);
        centerTextBind(title, getAppWidth() / 2.0, 300);

        var version = getUIFactoryService().newText(getSettings().getVersion(), Color.BLACK, 25);
        ...
        var menuBox = new VBox(
                ...
                new MenuButton("Help", 27, () -> instruct()),
    ...
    private void instruct() {
        ...
        pane.addRow(0, getUIFactoryService().newText(" Control:      "),
                new HBox(new KeyView(UP), new KeyView(DOWN), new KeyView(LEFT), new KeyView(RIGHT)));
