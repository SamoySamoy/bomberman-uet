...
public class SpriteSheet {
  ...
  // Constructor SpriteSheet with 2 parameters 'path' in string data type and 'SIZE' in integer data
  // type, to create
  ...
  // Method load() to load the pixels image object in RGB color: Bomber, Enemy, Bomb Flame,
  // Brick,....
  private void load() {
    try {
  ...
  public static SpriteSheet tiles = new SpriteSheet("src/main/resources/textures/classic.png", 256);
}
