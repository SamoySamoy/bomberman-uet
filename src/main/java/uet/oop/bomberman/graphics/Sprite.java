...
public class Sprite {
  ...
  /*
   * FlameSegment Sprites: Create object bomb flame, default range is 2px to the vertical and
   * horizontal, begin in the center position
   */
  ...
  public static Sprite explosion_vertical_1 =
      new Sprite(IMAGE_UNIT, 2, 5, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_vertical_2 =
      new Sprite(IMAGE_UNIT, 3, 5, 16, 16, SpriteSheet.tiles);

  public static Sprite explosion_horizontal =
      new Sprite(IMAGE_UNIT, 1, 7, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_horizontal_1 =
      new Sprite(IMAGE_UNIT, 1, 8, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_horizontal_2 =
      new Sprite(IMAGE_UNIT, 1, 9, 16, 16, SpriteSheet.tiles);

  public static Sprite explosion_horizontal_left_last =
      new Sprite(IMAGE_UNIT, 0, 7, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_horizontal_left_last_1 =
      new Sprite(IMAGE_UNIT, 0, 8, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_horizontal_left_last_2 =
      new Sprite(IMAGE_UNIT, 0, 9, 16, 16, SpriteSheet.tiles);

  public static Sprite explosion_horizontal_right_last =
      new Sprite(IMAGE_UNIT, 2, 7, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_horizontal_right_last_1 =
      new Sprite(IMAGE_UNIT, 2, 8, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_horizontal_right_last_2 =
      new Sprite(IMAGE_UNIT, 2, 9, 16, 16, SpriteSheet.tiles);

  public static Sprite explosion_vertical_top_last =
      new Sprite(IMAGE_UNIT, 1, 4, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_vertical_top_last_1 =
      new Sprite(IMAGE_UNIT, 2, 4, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_vertical_top_last_2 =
      new Sprite(IMAGE_UNIT, 3, 4, 16, 16, SpriteSheet.tiles);

  public static Sprite explosion_vertical_down_last =
      new Sprite(IMAGE_UNIT, 1, 6, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_vertical_down_last_1 =
      new Sprite(IMAGE_UNIT, 2, 6, 16, 16, SpriteSheet.tiles);
  public static Sprite explosion_vertical_down_last_2 =
      new Sprite(IMAGE_UNIT, 3, 6, 16, 16, SpriteSheet.tiles);
