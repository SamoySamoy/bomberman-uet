...
public class InfoLabel extends Label{
    ...
    public final static String BG_IMAGE = "/uet/oop/bomberman/images/yellow_button06.png";
    ...
    public InfoLabel(String text) {
        ...
        BackgroundImage bgImage = new BackgroundImage(new Image(getClass().getResourceAsStream(BG_IMAGE),
                380, 50, false, true),
